...
insert into Kategoria values(2,'Literatura piękna');
insert into Kategoria values(3,'Literatura faktu');
insert into Kategoria values(4,'Literatura dziecięca');
insert into Kategoria values(5,'Podręczniki');
insert into Kategoria values(6,'Encyklopedie i słowniki');
...
insert into Kategoria values(11,'Pozostałe');
...
insert into Ksiazka values(2,'Oskarżenie',2,2,3,3,'2017-09-27',7,368,9788365781703,20.80,3);
