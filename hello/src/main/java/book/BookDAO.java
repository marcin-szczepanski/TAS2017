...
public Boolean addBook(Book b) {
	String SQL = String.format("exec NewBook '%s','%s','%s','%s','%s','%s','%s',%s,'%s',%s,'%s',%s", b.nazwa,b.imie,b.nazwisko,b.wydawnictwo,b.gatunek,b.kategoria,b.rok_wyd,b.strony,b.isbn,b.cena,b.opis,b.ilosc);
	try {
		jdbcTemplateObject.update(SQL);
		return true;
...
public Boolean editBook(Book b) {
	String SQL = String.format("exec MODIFYBOOK	%s,'%s','%s','%s','%s','%s','%s','%s',%s,'%s','%s',%s,%s"
			, b.id, b.nazwa,b.imie,b.nazwisko,b.wydawnictwo,b.gatunek,b.kategoria,b.rok_wyd,b.strony,b.isbn,b.opis,b.cena,b.ilosc);
	try {
		jdbcTemplateObject.update(SQL);
		return true;
	} catch (DataAccessException e) {
